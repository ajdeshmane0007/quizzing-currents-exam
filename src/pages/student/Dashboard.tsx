  ...
  return (
    <MainLayout>
      <div className="mb-2 sm:mb-4 md:mb-6">
        <div className="bg-gradient-to-r from-quiz-purple/90 to-quiz-purple-dark rounded-lg p-2 sm:p-3 md:p-6 shadow-lg">
          <h1 className="text-lg sm:text-xl md:text-3xl font-bold text-white mb-0.5 sm:mb-1 md:mb-2">{`Welcome, ${currentUser?.name}`}</h1>
      ...
      <div className="space-y-2 sm:space-y-3 md:space-y-6 pb-16 md:pb-0">
        ...
        {/* Badges Section */}
        <div className="bg-gradient-to-r from-indigo-600/90 to-violet-500 rounded-lg p-2 sm:p-3 md:p-5 shadow-md text-white">
          <h3 className="font-bold text-sm sm:text-base md:text-lg mb-1 md:mb-3 flex items-center">
            <Sparkles className="mr-1 md:mr-2 h-4 w-4 sm:h-5 sm:w-5 md:h-6 md:w-6 text-yellow-300" />
            Your Achievements
          </h3>
        ...
        <div className="bg-gradient-to-r from-teal-500 to-cyan-600 rounded-lg p-2 sm:p-3 md:p-5 shadow-md text-white">
          <h3 className="font-bold text-sm sm:text-base md:text-lg mb-1 sm:mb-1.5 md:mb-2 flex items-center">
            <Target className="mr-1 md:mr-2 h-4 w-4 sm:h-5 sm:w-5 md:h-6 md:w-6" />
            Learning Paths
          </h3>
          <p className="mb-1.5 sm:mb-2 md:mb-4 text-xs md:text-sm text-white/90">Choose your path to academic excellence</p>
          <div className="grid grid-cols-2 gap-1.5 sm:gap-2 md:gap-3">
            <Link 
              to="/classes"
              className="flex flex-col items-center p-1.5 sm:p-2 md:p-4 bg-white/20 backdrop-blur-sm rounded-lg shadow-sm hover:bg-white/30 transition-all"
            >
              <BookOpen className="h-4 w-4 sm:h-5 sm:w-5 md:h-8 md:w-8 text-white mb-0.5 md:mb-2" />
            ...
            <Link 
              ...
              className="flex flex-col items-center p-1.5 sm:p-2 md:p-4 bg-white/20 backdrop-blur-sm rounded-lg shadow-sm hover:bg-white/30 transition-all"
            >
              <Award className="h-4 w-4 sm:h-5 sm:w-5 md:h-8 md:w-8 text-white mb-0.5 md:mb-2" />
        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden border border-indigo-100">
          <div className="bg-gradient-to-r from-indigo-500 to-purple-500 p-1.5 sm:p-2 md:p-4">
            <div className="flex justify-between items-center">
              <h2 className="text-sm sm:text-base md:text-lg font-semibold text-white flex items-center">
                <BookOpen className="h-3 w-3 sm:h-4 sm:w-4 md:h-5 md:w-5 mr-1 md:mr-2" />
                Latest Quizzes
              </h2>
              <Button asChild variant="secondary" size="sm" className="bg-white/20 hover:bg-white/30 text-white text-xs h-5 md:h-8 py-0 px-1 md:px-3">
          ...
          <div className="p-1.5 sm:p-2 md:p-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-1.5 sm:gap-2 md:gap-4">
              ...
              {recentQuizzes.length === 0 && (
                <div className="col-span-2 text-center py-2 sm:py-3 md:py-6 text-gray-500 text-xs sm:text-sm">
        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden border border-orange-100">
          <div className="bg-gradient-to-r from-orange-500 to-amber-500 p-1.5 sm:p-2 md:p-4">
            <div className="flex justify-between items-center">
              <h2 className="text-sm sm:text-base md:text-lg font-semibold text-white flex items-center">
                <Award className="h-3 w-3 sm:h-4 sm:w-4 md:h-5 md:w-5 mr-1 md:mr-2" />
                Upcoming Exams
              </h2>
              <Button asChild variant="secondary" size="sm" className="bg-white/20 hover:bg-white/30 text-white text-xs h-5 md:h-8 py-0 px-1 md:px-3">
          ...
          <div className="p-1.5 sm:p-2 md:p-4">
            <div className="grid gap-1.5 sm:gap-2 md:gap-4">
              {upcomingExams.slice(0, 1).map((exam) => (
                <ExamCard key={exam.id} exam={exam} />
              ))}
              {upcomingExams.length === 0 && (
                <div className="text-center py-2 sm:py-3 md:py-6 text-gray-500 text-xs sm:text-sm">
        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden border border-green-100">
          <div className="bg-gradient-to-r from-green-500 to-emerald-500 p-1.5 sm:p-2 md:p-4">
            <div className="flex justify-between items-center">
              <h2 className="text-sm sm:text-base md:text-lg font-semibold text-white flex items-center">
                <Lightbulb className="h-3 w-3 sm:h-4 sm:w-4 md:h-5 md:w-5 mr-1 md:mr-2" />
                Latest News
              </h2>
              <Button asChild variant="secondary" size="sm" className="bg-white/20 hover:bg-white/30 text-white text-xs h-5 md:h-8 py-0 px-1 md:px-3">
          ...
          <div className="p-1.5 sm:p-2 md:p-4">
            ...
            >
              ...
              <div className="flex justify-center mt-1 sm:mt-2 md:mt-4 gap-1 sm:gap-2">
                <CarouselPrevious className="static translate-y-0 h-5 w-5 sm:h-6 sm:w-6 md:h-8 md:w-8" />
                <CarouselNext className="static translate-y-0 h-5 w-5 sm:h-6 sm:w-6 md:h-8 md:w-8" />
              </div>
            </Carousel>
